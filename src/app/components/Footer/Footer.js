...
const Footer = () => {
  return (
    <footer className="bg-[#0a2d52] text-white">
        <div className="container py-12 ml-8">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div>
              ...
              <p className="text-sm text-gray-300 mb-4">
                Brindamos asesoramiento legal de calidad y soluciones personalizadas para nuestros clientes desde hace
                más de 20 años.
              </p>
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li>
                  <Link href="#testimonios" className="text-gray-300 hover:text-white">
                    Testimonios
                  </Link>
                </li>
                <li>
            ...
            <div>
              ...
              <form className="space-y-2">
                <input type="email" placeholder="Su email" className="w-full px-3 py-2 text-black rounded-md" />
                <button className="w-full bg-white text-[#0f3b6b] hover:bg-gray-100">Suscribirse</button>
              </form>
            </div>
          </div>

          <div className="border-t border-gray-700 mt-8 pt-8 text-center text-sm text-gray-400">
            <p>© {new Date().getFullYear()} GLHdev. Todos los derechos reservados.</p>
